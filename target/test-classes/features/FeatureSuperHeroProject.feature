...
Feature: SuperHero
  ...
  Scenario:  SuperHero
    ...
    And the extension chrome is "installed"
   ...
   # And I click superhero logo
    ...
    #And I click on "button-plain cookies-button" button of first video
    #And I click on "button-plain play play-button" button of first video
    Then the video is played


    #When I navigate to "wallet.superhero.com"
    #Then the page "wallet.superhero.com" is opened
    #When I install the extension
    #Then the extension is installed
    #When I repeat the tests